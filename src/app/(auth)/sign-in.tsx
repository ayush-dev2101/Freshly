...
export default function SignInScreen() {
  ...
  return (
    ...
    >
      ...
      {/* Class for the logo, quote and app image */}
      <View className="px-6 pt-4">
        <Text className="text-center text-5xl font-extrabold tracking-tighter text-primary-foreground uppercase font-mono dark:text-foreground">
          Freshly
        </Text>

        <Text className="mt-1 text-center text-[14px] text-primary-foreground/80 dark:text-foreground/75">
          Choose Smarter. Shop Happier.
        </Text>

        <View className="mt-6 rounded-[30px] border border-white/15 bg-white/10 p-3">
          <Image
